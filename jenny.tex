...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    \textbf{\href{https://g.co/kgs/DsNwjE}{\Large Jenny Fandrianto}} & \href{mailto:jenny.fto@gmail.com}{jenny.fto@gmail.com}\\
    {Program Manager} & {\href{tel:+14124951202}{+1-412-495-1202}} \\
\end{tabular*}
...
\section{Skills}
    \resumeSubHeadingListStart
        \resumeSubItem{Program Management}
            {Drive improvements with scalability.}
        \resumeSubItem{Executive Administrative Partnership}
            {Calendar, Travel, Budget, Team Building.}
        \resumeSubItem{Scripting and Programs}
...
\section{Experience}
    ...
    \resumeDoubleSubheading
      ...
      {Program Manager, Cloud}{05/2021-present}

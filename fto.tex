...
\section{Skills}
    \resumeSubHeadingListStart
        ...
        \resumeSubItem{Dusty Computer Languages}
            {Kotlin, Golang, Java, Scala, Jsonnet, Borgcfg, C, Javascript, C\#, R, Matlab.}
        \resumeSubItem{Homosapien Languages}
            {Conversant in Indonesian.}
        \resumeSubItem{Things}
            {google3, MapReduce++, Jupyter, pandas/sklearn/etc, TensorFlow, Superset, Presto/Trino, Docker, IntelliJ*, AWS, Git, Vim.}
